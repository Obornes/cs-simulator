...
variable "cp_ws_list" {
  ...
  default = [
    ...
    { cp_id = "FR*ORV*A0015", ws_url = "wss://ocpp.oreve.com" },
    ...
    { cp_id = "FR*ORV*A0016", ws_url = "wss://ocpp.oreve.com" }, # dont use this simulator any more because it is used by local simulators by developpers
  ]
}
