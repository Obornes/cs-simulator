...
describe("RequestStartTransaction (v201) - EVSE/connector resolution", () => {
  test("does not collide across different EVSEs sharing the same connectorId", async () => {
    ...
    try {
      ...
      // Before the fix, connectorId was hardcoded to 1 regardless of evseId,
      // so this second request would have been wrongly rejected as
      // "connector 1 already occupied".
